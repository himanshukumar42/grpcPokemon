...
type PokemonServiceClient interface {
	...
	DeletePokemon(ctx context.Context, in *DeletePokemonRequest, opts ...grpc.CallOption) (*UpdatePokemonResponse, error)
...
func (c *pokemonServiceClient) DeletePokemon(ctx context.Context, in *DeletePokemonRequest, opts ...grpc.CallOption) (*UpdatePokemonResponse, error) {
	out := new(UpdatePokemonResponse)
...
type PokemonServiceServer interface {
	...
	DeletePokemon(context.Context, *DeletePokemonRequest) (*UpdatePokemonResponse, error)
...
func (UnimplementedPokemonServiceServer) DeletePokemon(context.Context, *DeletePokemonRequest) (*UpdatePokemonResponse, error) {
